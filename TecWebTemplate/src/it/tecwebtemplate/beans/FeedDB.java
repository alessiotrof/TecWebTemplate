...
public class FeedDB implements Serializable {
	...
	// Lista contenente dei Feed
	private List<Feed> feeds;

	// Costruttore
	public FeedDB() {

		// Inizializziamo il Database con qualche informazione
		super();

		this.feeds = new ArrayList<Feed>();

		// Vado ad aggiungere dei Feed alla lista "feeds", solo per riempire un po' il DB :)
	...
	// Trova un feed appartenente ad una certa categoria
	...
	public List<Feed> find(String category) {
		...
		for (Feed f : feeds) {
			...
			// Se la categoria del feed in questione equivale a quella passata come argomento
			// allora lo aggiungo al risultato!
	...
	// Ottiene delle categorie che iniziano con la stringa passata come argomento
